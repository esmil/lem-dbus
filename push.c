...
static void
push_byte(lua_State *L, DBusMessageIter *args)
{
	unsigned char n;
...
static void
push_boolean(lua_State *L, DBusMessageIter *args)
{
	int b;
...
static void
push_int16(lua_State *L, DBusMessageIter *args)
{
	dbus_int16_t n;
	dbus_message_iter_get_basic(args, &n);
	lua_pushnumber(L, (lua_Number)n);
...
static void
push_uint16(lua_State *L, DBusMessageIter *args)
{
	dbus_uint16_t n;
	dbus_message_iter_get_basic(args, &n);
	lua_pushnumber(L, (lua_Number)n);
...
static void
push_int32(lua_State *L, DBusMessageIter *args)
{
	dbus_int32_t n;
	dbus_message_iter_get_basic(args, &n);
	lua_pushnumber(L, (lua_Number)n);
...
static void
push_uint32(lua_State *L, DBusMessageIter *args)
{
	dbus_uint32_t n;
	dbus_message_iter_get_basic(args, &n);
	lua_pushnumber(L, (lua_Number)n);
...
static void
push_int64(lua_State *L, DBusMessageIter *args)
{
	dbus_int64_t n;
	dbus_message_iter_get_basic(args, &n);
	lua_pushnumber(L, (lua_Number)n);
...
static void
push_uint64(lua_State *L, DBusMessageIter *args)
{
	dbus_uint64_t n;
	dbus_message_iter_get_basic(args, &n);
	lua_pushnumber(L, (lua_Number)n);
...
static void
push_double(lua_State *L, DBusMessageIter *args)
{
	double d;
...
static void
push_string(lua_State *L, DBusMessageIter *args)
{
	char *s;
...
static void
push_variant(lua_State *L, DBusMessageIter *args)
{
...
static void
push_dict(lua_State *L, DBusMessageIter *args)
{
...
static void
push_array(lua_State *L, DBusMessageIter *args)
{
	DBusMessageIter array_args;
	pushfunc pf;
	unsigned int i;
...
static void
push_struct(lua_State *L, DBusMessageIter *args)
{
...
static pushfunc
get_pushfunc(DBusMessageIter *args)
{
...
EXPORT int
lem_dbus_push_arguments(lua_State *L, DBusMessage *msg)
{
